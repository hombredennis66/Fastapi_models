...
class LLMService:
    ...
    def classifier(self):
        """Lazy load the sentiment analysis pipeline with truncation and quantization."""
        try:
            ...
            # Apply dynamic 8-bit quantization to the model's linear layers
            # to reduce CPU inference latency.
